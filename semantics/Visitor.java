...
public interface Visitor<S, T> {
	...
	public T visitExpGreater(ExpGreater exp, S arg) throws SmplException;
	public T visitExpLess(ExpLess exp, S arg) throws SmplException;
	public T visitExpLessEq(ExpLessEq exp, S arg) throws SmplException;
	public T visitExpGreatEqe(ExpGreatEq exp, S arg) throws SmplException;
	public T visitExpNotEqual(ExpNotEqual exp, S arg) throws SmplException;
	...
	public T visitExpAssign(ExpAssign exp, S arg) throws SmplException;
