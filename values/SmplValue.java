...
//    private Object val;
    ...
    public static SmplValue makeProc(ExpProc val1, Environment val2) {
        return new SmplProcedure(val1, val2);
    }
    ...
    public SmplValue pow(SmplValue arg) throws SmplException {
		throw new SmplTypeException("Cannot rise powers of non-numeric values");
	}

	public SmplValue eq(SmplValue arg) throws SmplException {
		throw new SmplTypeException("Operator not applicable: =");
	}
	...
	public SmplValue or(SmplValue arg) throws SmplException {
		throw new SmplTypeException("Operator not applicable: or");
	}

	public SmplValue and(SmplValue arg) throws SmplException {
		throw new SmplTypeException("Operator not applicable: and");
	}

	public SmplValue not() throws SmplException {
		throw new SmplTypeException("Operator not applicable: not");
	}
